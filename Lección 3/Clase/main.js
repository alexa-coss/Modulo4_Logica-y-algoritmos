...
class Viaje {
    ...
    agregarTarea(tarea){
        ...
        // return; -> También se puede poner aquí.
    }
...
/* const objViaje = new Viaje("Viaje de la familia", "CDMX", "Gudalajara", "15", "México");
...
const cargarViajes = () => {
    const datia = JSON.parse(localStorage.getItem('viajes')) || [];
...
// obj1===obj2? // Si eso se cunmple | Si no se cumple.
*/